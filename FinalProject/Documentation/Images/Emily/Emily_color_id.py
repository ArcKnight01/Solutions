...
def git_push():
    ...
    try:
        ...
        repo.git.add('/home/pi/AstroBeever/Images/Emily') #TODO: SAME THING HERE
...
def green(r, g, b):
    ...
    if mxx == g and 80 < g < 95 and b < 85 and r < 75:
        return True
    if 140 <= g <= 175 and b < 160 and r < 110:
        return True
    if 140 <= g <= 175 and b < 140 and r < 85:
        return True
...
YOUR_NAME = "Emily_" #TODO: CHANGE TO YOUR NAME OR THINGS WILL BE CONFUSING
