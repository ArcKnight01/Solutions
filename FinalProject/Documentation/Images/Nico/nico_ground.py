...
def git_push():
    try:
        repo = Repo('/home/nicom26/AstroBeever')
        repo.git.add('/home/nicom26/AstroBeever/Images/Nico') #PATH TO YOUR IMAGES FOLDER, SHOULD BE LOCATED IN FlatSatChallenge/Images/YOURFOLDER
