...
while True:
    ...
    while orbit_count<=3:
        ...
        if yaw > 84 and yaw < 110:
            ...
            dt_string = now.strftime("%d-%m-%Y_%H-%M-%S")
            yaw = round(yaw, 1)
            variable = 'Avik_' + '{p}_{yawval}_{timeval}'.format(p=2, yawval = yaw, timeval = dt_string) + '.jpg'
            # print(variable)
            camera.capture(variable)
            empty_list.append(variable)
            # print()
        ...
        if yaw > 290 and yaw < 325:
            ...
            dt_string = now.strftime("%d-%m-%Y_%H-%M-%S")
            yaw = round(yaw, 1)
            variable = 'Avik_' + '{p}_{yawval}_{timeval}'.format(p=3, yawval = yaw, timeval = dt_string) + '.jpg'
            # print(variable)
            camera.capture(variable)
            empty_list.append(variable)
            # print()
...
while True:
    ...
    while orbit_count<=3:
        if yaw > 200 and yaw < 214:
            ...
            dt_string = now.strftime("%d-%m-%Y_%H-%M-%S")
            yaw = round(yaw, 1)
            variable = 'Avik_' + '{p}_{yawval}_{timeval}'.format(p='A', yawval = yaw, timeval = dt_string) + '.jpg'
            # print(variable)
            empty_list.append(variable)
            camera.capture(variable)
            # print()
        ...
        if yaw > 84 and yaw < 110:
            ...
            dt_string = now.strftime("%d-%m-%Y_%H-%M-%S")
            yaw = round(yaw, 1)
            variable = 'Avik_' + '{p}_{yawval}_{timeval}'.format(p='B', yawval = yaw, timeval = dt_string) + '.jpg'
            # print(variable)
            camera.capture(variable)
            empty_list.append(variable)
            # print()
        ...
        if yaw > 290 and yaw < 325:
            ...
            dt_string = now.strftime("%d-%m-%Y_%H-%M-%S")
            yaw = round(yaw, 1)
            variable = 'Avik_' + '{p}_{yawval}_{timeval}'.format(p='C', yawval = yaw, timeval = dt_string) + '.jpg'
            # print(variable)
            camera.capture(variable)
            empty_list.append(variable)
            # print()
            # print("Took a picture!")
            serialsendfile(ser, variable, Image=True)
>>>>>>> 6c147ac97ef3f28b8d6e9f9a2b62e2550067346d
