...
def git_push():
    try:
        repo = Repo('/home/Alm/AstroBeever')
        repo.git.add('/home/Alm/AstroBeever/Images/Albert') #PATH TO YOUR IMAGES FOLDER, SHOULD BE LOCATED IN FlatSatChallenge/Images/YOURFOLDER
