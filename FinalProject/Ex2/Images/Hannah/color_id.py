...
def git_push():
    ...
    try:
        repo = Repo('/home/pi/AstroBeever') #TODO: MAKE SURE TO REPLACE "nicom26" you YOUR username
        repo.git.add('/home/pi/AstroBeever/Images/Hannah') #TODO: SAME THING HERE
...
def green(r, g, b):
    ...
    if mxx == g and 95 < g < 130 and 75 < r < 115 and 90 < b < 125:
        return True
    if 130 < g < 145 and abs(b-g) < 6 and 110 < r < 145:
        return True
    
    if mxx == g and 80 < g < 100 and 50 < r < 80 and 60 < b < 90:
        return True
    
    
    if 55 <= g <= 70 and b < 40 and r < 25:
        return True
    return False
...
def blue(r, g, b):
    ...
    if mxx == b and 60 < b < 80 and 40 < r < 60 and 25 < g < 45:
        return True
    ...
    if mxx == b and 160 < b < 190 and 110 < r < 155 and 105 < g < 135:
        return True
...
def white(r, g, b):
    ...
    if 245 < r < 256 and g > 220 and b > 200:
        return True
...
def color_id(image_file):
    ...
    # into white. For Hannah, if the white is too little compared to the plastic, assume the too light is also white
    if color_amount["white"] < 100:
        color_amount["white"] = color_amount["light_blue"]
        
    elif color_amount["light_blue"] < color_amount["white"]:
        color_amount["white"] += color_amount["light_blue"]
...
YOUR_NAME = "Hannah_" #TODO: CHANGE TO YOUR NAME OR THINGS WILL BE CONFUSING
